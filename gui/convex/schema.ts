...
export default defineSchema({
  ...
  settings: defineTable({
    ...
    // Local LLM (cera-vLLM) integration
    localLlmEnabled: v.optional(v.boolean()),   // Master toggle
    localLlmEndpoint: v.optional(v.string()),   // e.g., "http://192.168.1.50:8100"
    localLlmApiKey: v.optional(v.string()),     // Auto-generated by cera-vLLM dashboard
  }),
